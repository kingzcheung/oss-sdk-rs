...
pub use types::{
    ...
    GetObjectOutput, HeadObjectInput, HeadObjectOutput, HeadObjectStatus,
    InitiateMultipartUploadInput, InitiateMultipartUploadOutput, ListBucketsInput,
    ListBucketsOutput, ListMultipartUploadsInput, ListMultipartUploadsOutput, ListObjectsInput,
    ListObjectsOutput, ListPartsInput, ListPartsOutput, MultipartUpload, Object, ObjectAcl,
    ObjectAclPermission, ObjectIdentifier, ObjectType, OwnerInfo, PartInfo, PartItem,
    PostObjectInput, PostObjectOutput, PutObjectAclInput, PutObjectAclOutput, PutObjectInput,
    PutObjectOutput, RegionInfo, RestoreInfo, RestoreObjectInput, RestoreObjectOutput,
    RestoreStatus, SealAppendObjectInput, SealAppendObjectOutput, ServerSideEncryption,
    ServerSideEncryptionRule, StorageClass, SuccessActionStatus, Tier, UploadPartCopyInput,
    UploadPartCopyOutput, UploadPartCopyResponse, UploadPartInput, UploadPartOutput,
};
